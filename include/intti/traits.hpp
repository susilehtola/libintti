...
/// ever used for reference values, never on a device). Everything else --
/// __float128, std::complex, class-type scalars such as MPFR wrappers --
/// takes the serial host path of eri_quartet().
///
